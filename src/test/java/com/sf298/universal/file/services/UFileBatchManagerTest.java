...
public class UFileBatchManagerTest {
    ...
    public UFileBatchManagerTest(UFile[] roots) {
        ...
        for (int i = 0; i < roots.length; i++) {
            this.uFile1[i] = this.roots[i].stepInto("File1.txt");
            this.uFile111[i] = this.roots[i].stepInto("folder1"+ this.roots[i].getFileSep()+"folder11"+ this.roots[i].getFileSep()+"File1.txt");
            this.uFolder1[i] = this.roots[i].stepInto("folder1");
            this.uFolder11[i] = this.roots[i].stepInto("folder1"+ this.roots[i].getFileSep()+"folder11");
            this.uFolder111[i] = this.roots[i].stepInto("folder1"+ this.roots[i].getFileSep()+"folder11"+ this.roots[i].getFileSep()+"folder111");
        }
    }
/*
    @BeforeEach
